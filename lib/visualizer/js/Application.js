...
Visualizer = function(container, options, w, h, configOverrides) {
	...
	try {
        ...
        */
        ...
        //this.imgMgr.put('ship_p1', 'Ship1.png');
		//this.imgMgr.put('ship_p2', 'Ship2.png');
		...
		//this.imgMgr.put('rob_powerup', 'rob_powerup.png');
		//this.imgMgr.put('ship_with_rob_powerup', '4-Ships_with_rob_powerup.png');
		//this.imgMgr.put('move_powerup', 'move_powerup.png');
		//this.imgMgr.put('ship_with_move_powerup', '4-Ships_with_move_powerup.png');
		this.imgMgr.put('speed_powerup', 'speed_powerup.png');
		//this.imgMgr.put('ship_with_speed_powerup', '4-Ships_with_speed_powerup.png');
...
Visualizer.prototype.tryStart = function() {
	...
	if (this.state.replay) {
        ...
        this.imgMgr.patterns['movePowerupOnShip'] = this.imgMgr.images['ship_with_move_powerup'];
		...
		*/
        ...
        //this.map.movePowerup = this.imgMgr.images['move_powerup'];
        //this.map.movePowerupOnShip = this.imgMgr.patterns['movePowerupOnShip'];
